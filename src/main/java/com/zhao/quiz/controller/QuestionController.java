...
//试题添加或者修改操作，先去添加页面
    ...
    public String addQuestion(Question question, @RequestParam("image") MultipartFile image) {
        // 处理图片上传
...
//试题去修改页面
    ...
    public String EditQuestion(Question question, @RequestParam("image") MultipartFile image) {
        // 处理图片上传
        String imageUrl = uploadImage(image);
        question.setQuestionImage(imageUrl);
